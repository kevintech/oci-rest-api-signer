...
public final class OCIRESTAPIHelper {
    ...
    private static String advancedSignRequest(String method,
        ...
        if (signer == null) {
            ...
            final Signature signature = new Signature(apiKey, SIGNATURE_ALGORITHM, null, REQUIRED_HEADERS.get(!isSpecial? method : "get"));
            signer = new Signer(privateKey, signature);
        ...
        headers.put("date", dateHeader);
        headers.put("host", hostHeader);
        /* Special implementation doesn't requires these headers
        *  Please see: https://docs.cloud.oracle.com/iaas/Content/API/Concepts/signingrequests.htm#five
        */
        if (!isSpecial) {
     ...
     * @param administratorKeyFingerprint the administrator key fingerprint
     * @param privateKeyString            the private key
     * @param isSpecial                   if is an special implementation of the request
    ...
    public static String signPutRequest(String dateHeader,
                                        ...
                                        String privateKeyString,
                                        boolean isSpecial) throws IOException {
        return advancedSignRequest("put", PUT_SIGNERS, dateHeader, path, hostHeader, body, compartmentOCID, administratorOCID, administratorKeyFingerprint, privateKeyString, isSpecial);
    }
    ...
    public static String signPostRequest(String dateHeader,
                                         ...
                                         String privateKeyString,
                                         boolean isSpecial) throws IOException {
        return advancedSignRequest("post", POST_SIGNERS, dateHeader, path, hostHeader, body, compartmentOCID, administratorOCID, administratorKeyFingerprint, privateKeyString, isSpecial);
    }
