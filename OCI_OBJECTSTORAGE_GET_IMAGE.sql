...
create or replace function GET_IMAGE( p_identity_domain_name in varchar2,
...
begin
  ...
  l_file := APEX_WEB_SERVICE.CLOBBASE642BLOB (l_response);
  return l_file; -- in BLOB/BINARY format
